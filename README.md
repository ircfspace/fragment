...
### برای فرگمنت چه خروجی‌هایی در دسترسه؟
ابزار فرگمنت در ابتدای امر بهتون فایل JSON تحویل میداد، اما الان میتونین به‌شکل یک لینک ساب یا از طریق اسکن QRCODE با سهولت بیشتری از ویژگی فرگمنت استفاده کنین
...
### برای کاهش پینگ و بهبود سرعت چکار کنیم؟
آپشن‌هایی که در ابزار فرگمنت وجود داره حاوی توضیحات به چندزبان مختلف هستن، با این‌حال برای کاهش پینگ در استفاده از فرگمنت میتونین آیتم‌های Mux و Early Data رو علامت بزنین
* https://t.me/ircfspace/292
* https://t.me/ircfspace/185

### راهنمای ویدئویی براش نیست؟
یه‌سری از دوستان زحمت کشیدن در رابطه با فرگمنت یا این‌ابزار در یوتیوب توضیح دادن:<br>
...
* to participate in translating the tool into other languages, you can follow the steps below:<br> https://github.com/ircfspace/fragment/tree/main/assets/lang
* https://ircf.space
