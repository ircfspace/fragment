...
آپشن‌هایی که در ابزار فرگمنت وجود داره حاوی توضیحات به چندزبان مختلف هست، با این‌حال برای کاهش پینگ در استفاده از فرگمنت میتونین آیتم‌های Mux و Early Data رو علامت بزنین
* https://t.me/ircfspace/292
* https://t.me/ircfspace/185

### راهنمای ویدئویی براش نیست؟
یه‌سری از دوستان زحمت کشیدن در رابطه با فرگمنت یا این‌ابزار توضیح دادن:<br>
